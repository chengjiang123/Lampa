...
from utils.losses import InfoNCELoss, FocalLoss, knnInfoNCELoss, knnTripletLoss, SegCriterion
...
def get_loss(loss_name, loss_kwargs):
    if loss_name == "infonce":
        ...
        return CondensationLossTiger()
    elif loss_name == "knninfonce":
        return knnInfoNCELoss(**loss_kwargs)
    elif loss_name == "knntriplet":
        return knnTripletLoss(**loss_kwargs)
    elif loss_name == "segcluster":
        return SegCriterion(**loss_kwargs)
    else:
