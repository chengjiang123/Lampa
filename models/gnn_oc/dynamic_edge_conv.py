...
class DynamicEdgeConv(MessagePassing):
    ...
    def forward(
        self,
        x: Union[Tensor, PairTensor],  # Replace Tensor | PairTensor with Union[Tensor, PairTensor]
        batch: Union[OptTensor, PairTensor, None] = None  # Replace OptTensor | PairTensor | None with Union[OptTensor, PairTensor, None]
    ) -> Tensor:
