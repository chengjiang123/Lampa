...
class ResidualNetwork(ABC, nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr) -> Tuple[T, T, Union[List[T], None]]:
        """Forward pass
...
class ResIN(nn.Module, HyperparametersMixin):
    def __init__(
        ...
        *,
        ...
        residual_kwargs: Union[dict, None] = None,
    ):
    ...
    def forward(
        self, x: T, edge_index: T, edge_attr: T
    ) -> Tuple[T, T, List[T], Union[List[T], None]]:
