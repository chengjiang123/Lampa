...
from .fla_op import exp, log
from .fla_utils import autocast_custom_bwd, autocast_custom_fwd, get_multiprocessor_count, input_guard
...
# somewhere at the top of your module
_has_is_compiling = hasattr(torch.compiler, "is_compiling")

def _is_compiling() -> bool:
    # if the API exists, call it; otherwise act as if we're not compiling
    return torch.compiler.is_compiling() if _has_is_compiling else False
