...
#load(name="wind",sources=[f'{base_path}/cuda/wind_rwkv7.cu',f'{base_path}/cuda/wind_rwkv7.cpp'],is_python_module=False,verbose=True,extra_cuda_cflags=[f'-D_C_={head_size_a}',"-res-usage","--use_fast_math", "-O3", "-Xptxas -O3", "--extra-device-vectorization","-gencode=arch=compute_80,code=sm_80"])
